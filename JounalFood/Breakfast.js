...
const Breakfast = () => {
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
          headerTitle: () => (
            <Text style={{ fontSize: 20, fontWeight: "bold", fontFamily: 'Kanit_400Regular',justifyContent:'center' }}>บันทึกการกินอาหารเช้า</Text>
          ),
          headerStyle: {
      ...
      const createFood = async () => {
        try {
          ...
          navigation.navigate('Jounal'); // Navigate back to the food list
        } catch (error) {
